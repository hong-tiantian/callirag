...
# 编号与 gt 图一致（callirag/cases/gt/{编号}.jpg）
...
def main() -> None:
    callirag_root = Path(__file__).resolve().parents[1]
    repo_root = callirag_root.parent
    font_path = repo_root / "data" / "SourceHanSansSC-Regular.otf"
    out_img_dir = callirag_root / "cases" / "content"
    out_csv = callirag_root / "cases" / "wxz_gt_chars.csv"
